---
name: deliverability-troubleshooter
displayName: "Deliverability Troubleshooter"
version: 1.0.0
description: Diagnose and fix email deliverability issues including spam folder placement, bounces, and ESP blocking
...
- name: issue_type
type: string
description: Type of deliverability problem
enum: ["low_delivery", "spam_folder", "high_bounce", "esp_blocking", "domain_reputation"]
required: false
- name: campaign_name
type: string
description: Affected campaign
required: false
- name: affected_domains
type: string[]
description: ESP domains experiencing issues (e.g., ["gmail.com", "outlook.com"])
required: false
