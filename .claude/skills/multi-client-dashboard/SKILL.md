...
displayName: "Multi-Client Dashboard"
version: 1.0.0
description: Cross-campaign performance aggregation and client-specific reporting for agencies managing multiple accounts
...
input:
arguments:
- name: client_name_or_id
type: string
description: Specific client to report on (optional, defaults to all clients)
required: false
- name: date_range
type: string
description: Reporting period (e.g., "last month", "Q4 2025", "YTD")
required: false
default: "last month"
- name: report_type
type: string
description: Type of dashboard report
enum: ["executive_summary", "detailed_performance", "portfolio_overview", "client_comparison"]
default: "portfolio_overview"
required: false
