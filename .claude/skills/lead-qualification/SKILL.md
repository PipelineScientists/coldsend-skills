...
displayName: "Lead Qualification & Scoring"
version: 1.0.0
description: CSV validation, lead scoring, and Ideal Customer Profile (ICP) matching for cold email campaigns
...
- name: csv_file_path
type: string
description: Path to CSV file with leads
required: false
- name: campaign_name
type: string
description: Campaign to upload leads to
required: false
- name: scoring_criteria
type: object
description: Custom ICP criteria for scoring
required: false
properties:
  industries:
    type: array
