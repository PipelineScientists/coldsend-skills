---
name: sender-reputation-monitor
displayName: "Sender Reputation Monitor"
version: 1.0.0
description: Track sender scores across ESPs, monitor domain reputation, and manage inbox warmup progress
...
input:
arguments:
- name: domain_or_inbox
type: string
description: Domain or inbox to check (e.g., "company.com" or "john@company.com")
required: false
- name: check_type
type: string
description: Type of reputation check
enum: ["full_audit", "google_postmaster", "microsoft_snds", "warmup_progress", "blacklist_check"]
default: "full_audit"
required: false
