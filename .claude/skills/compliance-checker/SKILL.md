...
version: 1.0.0
description: CAN-SPAM, GDPR, and regional regulation compliance verification for cold email campaigns
...
type: string
description: Campaign to audit for compliance
required: false
- name: regions
type: array
description: Geographic regions to check compliance for
items:
  type: string
  enum: ["US", "EU", "UK", "Canada", "Australia", "Global"]
default: ["US", "EU"]
required: false
- name: audit_type
type: string
description: Type of compliance audit
enum: ["quick_check", "full_audit", "ongoing_monitoring"]
default: "full_audit"
required: false
